...
; TR.R - Right Turn
    ...
    (define-turn-sound (turn TR.R|TR.SR|TR.HR|NR.R pos *)

      (text (data "TURN RIGHT")))

; TR.L - Left Turn

    (define-turn-sound (turn TR.L|TR.SL|TR.HL|NR.L pos *)
...
; KP.R - Keep to the right (Split)
    ...
    (define-turn-sound (turn KP.R|KH.R|KS.R pos *)

      (text (data "KEEP RIGHT")))

; KP.L - Keep to the left (Split)

    (define-turn-sound (turn KP.L|KH.L|KS.L pos *)
...
; ST.L|R - Stay on
    ...
    (define-turn-sound (turn ST.L|SH.L|ST.R|ST.L pos *)
