...
set(Qt5IviVehicleFunctions_VERSION_STRING 1.0.0)
...
macro(_populate_IviVehicleFunctions_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5IviVehicleFunctions_install_prefix}/lib/${LIB_LOCATION}")
    _qt5_IviVehicleFunctions_check_file_exists(${imported_location})
    set_target_properties(Qt5::IviVehicleFunctions PROPERTIES
        "INTERFACE_LINK_LIBRARIES" "${_Qt5IviVehicleFunctions_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        "IMPORTED_SONAME_${Configuration}" "libQt5IviVehicleFunctions.so.1"
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5IviVehicleFunctions_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::IviVehicleFunctions)
    ...
    set(Qt5IviVehicleFunctions_PRIVATE_INCLUDE_DIRS
        "${_qt5IviVehicleFunctions_install_prefix}/include/QtIviVehicleFunctions/1.0.0"
        "${_qt5IviVehicleFunctions_install_prefix}/include/QtIviVehicleFunctions/1.0.0/QtIviVehicleFunctions"
    )
    ...
    foreach(_module_dep ${_Qt5IviVehicleFunctions_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                1.0.0 ${_Qt5IviVehicleFunctions_FIND_VERSION_EXACT}
    ...
    _populate_IviVehicleFunctions_target_properties(RELEASE "libQt5IviVehicleFunctions.so.1.0.0" "" )
