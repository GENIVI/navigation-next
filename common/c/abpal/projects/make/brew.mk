...
SRC_DIRS := $(PROJ_ROOT)/src/brew/audio
SRC_DIRS += $(PROJ_ROOT)/src/brew/gps
...
NIMNBIPAL_DIR += $(NIMNBIPAL_DIR)/private

ADSK_INC :=  $(THIRDPARTY_ROOT)/adsk
...
export AS LD CC CPP AR NM STRIP OBJCOPY OBJDUMP MAKE AWK TCC ACC ARMLINK
