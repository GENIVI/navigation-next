...
!INCLUDE abipal_common_files.mak          # All files

#----------------------------------------------------------------------------
# Lib file targets
#----------------------------------------------------------------------------

nimabpal.$(OBJ) : $(NIMABPAL)
        @cmd /c echo ---------------------------------------------------------------
        @cmd /c echo TARGET $@
        $(LD) --partial $(LINK_CMD) nimabpal.$(OBJ) $(NIMABPAL)

#$(TARGET).$(MODULE) : $(TARGET).$(EXETYPE) $(NIMABPAL)
#        @cmd /c echo ---------------------------------------------------------------
#        @cmd /c echo TARGET $@
#        $(HEXTOOL)  $(TARGET).$(EXETYPE) $(BINFORMAT) $(TARGET).$(MODULE)

#$(TARGET).$(EXETYPE) : $(ALL_APP_OBJS) $(NIMABPAL)
#        @cmd /c echo ---------------------------------------------------------------
#        @cmd /c echo TARGET $@        
