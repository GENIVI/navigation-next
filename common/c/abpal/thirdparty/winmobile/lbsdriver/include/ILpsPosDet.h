...
//We handle this through device files now.

/*#if defined MOTV325
  #define AEECLSID_LPSPOSDET    	0x01035380
#elif defined LG8100
  //#define AEECLSID_LPSPOSDET    	0x01039052
  #define AEECLSID_LPSPOSDET    	0x01035380	// the 8100 ILPSPosDet that we have uses this Class ID
#elif defined LG9800
  #define AEECLSID_LPSPOSDET    	0x01044ed0
#elif defined MOTRAZR
  #define AEECLSID_LPSPOSDET    	0x01039e15
#elif defined MOTVE
  #define AEECLSID_LPSPOSDET    	0x010417e2
#elif defined SCHA930
  #define AEECLSID_LPSPOSDET    	0x01044ece
#elif defined LG8300
  #define AEECLSID_LPSPOSDET    	0x01044ed4
#elif defined SCHA870
 #define AEECLSID_LPSPOSDET         0x01044ecc
#elif defined LG5300
 #define AEECLSID_LPSPOSDET         0x0103d013
#elif defined LG9900
 #define AEECLSID_LPSPOSDET         0x0103dc80
#elif defined SCHA990
 #define AEECLSID_LPSPOSDET         0x01044ed2
#elif defined LG8500
 #define AEECLSID_LPSPOSDET         0x0103de7e
#elif defined LG8600
 #define AEECLSID_LPSPOSDET			0x0103dc5a
#elif defined NOKIA6315i
 #define AEECLSID_LPSPOSDET         0x0103fa2c
#elif defined GZ1V
 #define AEECLSID_LPSPOSDET         0x0103e80f
#elif defined K323
 #define AEECLSID_LPSPOSDET         0x01040f5c
#elif defined SCHU740
 #define AEECLSID_LPSPOSDET         0x01041607
#elif defined SCHU620
 #define AEECLSID_LPSPOSDET         0x01042937
#elif defined LG9400
 #define AEECLSID_LPSPOSDET         0x0104293b
#elif defined GZ1S
 #define AEECLSID_LPSPOSDET         0x0104293c
#elif defined LG8700
 #define AEECLSID_LPSPOSDET         0x01042e71
#elif defined SCHU540
 #define AEECLSID_LPSPOSDET         0x01043DC8
#elif defined MOTW385 
 #define AEECLSID_LPSPOSDET         0x0104403c 
#elif defined MOTV9M 
 #define AEECLSID_LPSPOSDET         
#elif defined MOTZ6TV 
 #define AEECLSID_LPSPOSDET         
#elif defined LG8550 
 #define AEECLSID_LPSPOSDET  	    0x01046c9c	
#elif defined LG5400
 #define AEECLSID_LPSPOSDET         0x0103d013
#elif  defined MOTQ
#define AEECLSID_LPSPOSDET   	    0x0104a032
#elif  defined MOTQ_TELUS
#define AEECLSID_LPSPOSDET   	    0x0104a032
#elif  defined GEN_WINMOBILE
#define AEECLSID_LPSPOSDET   	    0x0104a032
#else
  #define AEECLSID_LPSPOSDET    	0x01035380  // for now default is Motorola v325.
#endif*/
