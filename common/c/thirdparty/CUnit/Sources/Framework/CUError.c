 ...
 * @see CU_ErrorCode
 */
CU_DEFINE CU_ErrorCode CU_get_error(void)
{
 ...
 * @see CU_ErrorCode
 */
CU_DEFINE const char* CU_get_error_msg(void)
{
 ...
 * @see CU_ErrorAction
 */
CU_DEFINE void CU_set_error_action(CU_ErrorAction action)
{
 ...
 * @see CU_ErrorAction
 */
CU_DEFINE CU_ErrorAction CU_get_error_action(void)
{
