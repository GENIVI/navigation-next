 ...
 */
CU_DEFINE CU_ErrorCode CU_initialize_registry(void)
{
  CU_ErrorCode result;
 ...
 *  @see CU_cleanup_registry
 */
CU_DEFINE CU_BOOL CU_registry_initialized(void)
{
 ...
 *  @see CU_set_registry
 */
CU_DEFINE void CU_cleanup_registry(void)
{
  assert(CU_FALSE == CU_is_test_running());
 ...
 *  @see CU_set_registry
 */
CU_DEFINE CU_pTestRegistry CU_get_registry(void)
{
 ...
 *  @see CU_get_registry
 */
CU_DEFINE CU_pTestRegistry CU_set_registry(CU_pTestRegistry pRegistry)
{
 ...
 */
CU_DEFINE CU_pSuite CU_add_suite(const char* strName, CU_InitializeFunc pInit, CU_CleanupFunc pClean)
{
 ...
 */
CU_DEFINE CU_pTest CU_add_test(CU_pSuite pSuite, const char* strName, CU_TestFunc pTestFunc)
{
 ...
 */
CU_DEFINE CU_ErrorCode CU_register_nsuites(int suite_count, ...)
{
 ...
 *  @see CU_register_suites()
 */
CU_DEFINE CU_ErrorCode CU_register_suites(CU_SuiteInfo suite_info[])
{
 ...
 *  CU_set_registry().
 */
CU_DEFINE CU_pTestRegistry CU_create_new_registry(void)
{
 ...
 */
CU_DEFINE void CU_destroy_existing_registry(CU_pTestRegistry* ppRegistry)
{
 ...
 *          NULL if not found.
 */
CU_DEFINE CU_pSuite CU_get_suite_by_name(const char* szSuiteName, CU_pTestRegistry pRegistry)
{
  CU_pSuite pSuite = NULL;
  CU_pSuite pCur = NULL;
 ...
 *          NULL if not found.
 */
CU_DEFINE CU_pTest CU_get_test_by_name(const char* szTestName, CU_pSuite pSuite)
{
  CU_pTest pTest = NULL;
  CU_pTest pCur = NULL;
