 ...
 */
CU_DEFINE int CU_translate_special_characters(const char* szSrc, char* szDest, size_t maxlen)
{
	int count = 0;
	size_t src = 0;
	size_t dest = 0;
 ...
 */
CU_DEFINE int CU_compare_strings(const char* szSrc, const char* szDest)
{
  assert(NULL != szSrc);
  assert(NULL != szDest);
 ...
 */
CU_DEFINE void CU_trim(char* szString)
{
 ...
 *  @param szString  The string to trim.
 */
CU_DEFINE void CU_trim_left(char* szString)
{
	int nOffset = 0;
	char* szSrc = szString;
 ...
 *  @param szString  The string to trim.
 */
CU_DEFINE void CU_trim_right(char* szString)
{
	size_t nLength;
	char* szSrc = szString;
