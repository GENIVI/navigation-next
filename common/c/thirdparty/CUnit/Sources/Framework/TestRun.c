 ...
 */
CU_DEFINE CU_BOOL CU_assertImplementation(CU_BOOL bValue, 
                                unsigned int uiLine,
                                char strCondition[], 
                                char strFile[],
                                char strFunction[], 
...
CU_DEFINE void CU_set_test_start_handler(CU_TestStartMessageHandler pTestStartHandler)
{
...
CU_DEFINE void CU_set_test_complete_handler(CU_TestCompleteMessageHandler pTestCompleteHandler)
{
...
CU_DEFINE void CU_set_all_test_complete_handler(CU_AllTestsCompleteMessageHandler pAllTestsCompleteHandler)
{
 ...
 */
CU_DEFINE void CU_set_suite_init_failure_handler(CU_SuiteInitFailureMessageHandler pSuiteInitFailureHandler)
{
 ...
 */
CU_DEFINE void CU_set_suite_cleanup_failure_handler(CU_SuiteCleanupFailureMessageHandler pSuiteCleanupFailureHandler)
{
...
CU_DEFINE CU_TestStartMessageHandler CU_get_test_start_handler(void)
{
...
CU_DEFINE CU_TestCompleteMessageHandler CU_get_test_complete_handler(void)
{
...
CU_DEFINE CU_AllTestsCompleteMessageHandler CU_get_all_test_complete_handler(void)
{
 ...
 */
CU_DEFINE CU_SuiteInitFailureMessageHandler CU_get_suite_init_failure_handler(void)
{
 ...
 */
CU_DEFINE CU_SuiteCleanupFailureMessageHandler CU_get_suite_cleanup_failure_handler(void)
{
 ...
 */
CU_DEFINE unsigned int CU_get_number_of_suites_run(void)
{
 ...
 *  @see CU_get_number_of_tests_run()
 */
CU_DEFINE unsigned int CU_get_number_of_suites_failed(void)
{
 ...
 */
CU_DEFINE unsigned int CU_get_number_of_tests_run(void)
{
 ...
 *  @see CU_get_number_of_suites_run()
 */
CU_DEFINE unsigned int CU_get_number_of_tests_failed(void)
{
 ...
 */
CU_DEFINE unsigned int CU_get_number_of_asserts(void)
{
 ...
 *  @see CU_get_number_of_failures()
 */
CU_DEFINE unsigned int CU_get_number_of_successes(void)
{
 ...
 *  @see CU_get_number_of_successes()
 */
CU_DEFINE unsigned int CU_get_number_of_failures(void)
{
 ...
 *  The count is reset each time the client initiates a run.
 */
CU_DEFINE unsigned int CU_get_number_of_failure_records(void)
{
 ...
 *  @see CU_get_number_of_successes()
 */
CU_DEFINE CU_pFailureRecord CU_get_failure_list(void)
{
 ...
 *  @see CU_get_number_of_successes()
 */
CU_DEFINE CU_pRunSummary CU_get_run_summary(void)
{
 ...
 */
CU_DEFINE CU_ErrorCode CU_run_all_tests(void)
{
 ...
 */
CU_DEFINE CU_ErrorCode CU_run_suite(CU_pSuite pSuite)
{
  CU_ErrorCode result;
 ...
 */
CU_DEFINE CU_ErrorCode CU_run_test(CU_pSuite pSuite, CU_pTest pTest)
{
  CU_ErrorCode result;
  CU_ErrorCode result2;
 ...
 */
CU_DEFINE void CU_clear_previous_results(void)
{
  clear_previous_results(&f_run_summary, &f_failure_list);
}
 ...
 */
CU_DEFINE CU_pSuite CU_get_current_suite(void)
{
  return f_pCurSuite;
}
 ...
 */
CU_DEFINE CU_pTest CU_get_current_test(void)
{
  return f_pCurTest;
}
 ...
 */
CU_DEFINE CU_BOOL CU_is_test_running(void)
{
