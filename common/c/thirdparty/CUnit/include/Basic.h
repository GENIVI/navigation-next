...
#ifdef WIN32
  #define RESULT_FILE_PATH     ".\\TestsResult\\Result.txt"
  #define RESULT_FOLDER_PATH   ".\\TestsResult\\"
#else
  #if defined(ANDROID_NDK)
    #define RESULT_FILE_PATH     "./mnt/sdcard/Result.txt"
    #define RESULT_FOLDER_PATH   "./mnt/sdcard/"
  #else
  #define RESULT_FILE_PATH     "./TestsResult/Result.txt"
  #define RESULT_FOLDER_PATH   "./TestsResult/"
#endif
