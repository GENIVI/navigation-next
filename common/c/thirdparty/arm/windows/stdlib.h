...
extern _ARMABI long int atol(const char * /*nptr*/);
    ...
    */
#if !defined(__STRICT_ANSI__) || (defined(__STDC_VERSION__) && 199901L <= __STDC_VERSION__)
extern _ARMABI long long int atoll(const char * /*nptr*/);
   /*
...
extern _ARMABI double strtod(const char * /*nptr*/, char ** /*endptr*/);
   /*
    * converts the initial part of the string pointed to by nptr to double
    ...
    *          stored in errno.
    */
extern _ARMABI long int strtol(const char * /*nptr*/, char **/*endptr*/, int /*base*/);
   /*
    * converts the initial part of the string pointed to by nptr to long int
    * representation. First it decomposes the input string into three parts:
    * an initial, possibly empty, sequence of white-space characters (as
    ...
    */
extern _ARMABI unsigned long int strtoul(const char * /*nptr*/,
...
#if !defined(__STRICT_ANSI__) || (defined(__STDC_VERSION__) && 199901L <= __STDC_VERSION__)
extern _ARMABI long long int strtoll(const char * /*restrict*/ /*nptr*/,
    ...
    * macro ERANGE is stored in errno.
    */
extern _ARMABI unsigned long long int strtoull(const char * /*restrict*/ /*nptr*/,
                                       char ** /*restrict*/ /*endptr*/, int /*base*/);
   /*
...
#if !defined(__STRICT_ANSI__) || (defined(__STDC_VERSION__) && 199901L <= __STDC_VERSION__)
extern _ARMABI_PURE long long llabs(long long /*j*/);
   /*
    ...
    */
#ifdef __cplusplus
   extern "C++" inline _ARMABI_PURE long long abs(long long x) { return llabs(x); }
#endif
