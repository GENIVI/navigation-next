...
_ARMABI intmax_t strtoimax(const char * /*restrict*/ /*nptr*/,
                   char ** /*restrict*/ /*endptr*/, int /*base*/);
    /* as for strtol */
_ARMABI uintmax_t strtoumax(const char * /*restrict*/ /*nptr*/,
                    char ** /*restrict*/ /*endptr*/, int /*base*/);
    /* as for strtoul */

_ARMABI intmax_t wcstoimax(const wchar_t * restrict /*nptr*/,
                   wchar_t ** /*restrict*/ /*endptr*/, int /*base*/);
_ARMABI uintmax_t wcstoumax(const wchar_t * restrict /*nptr*/,
                    wchar_t ** /*restrict*/ /*endptr*/, int /*base*/);
