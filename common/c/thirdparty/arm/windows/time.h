...
#ifndef __STRICT_ANSI__
extern _ARMABI char *asctime_r(const struct tm * /*timeptr*/, char * /*buf*/);
#endif
   /*
...
#ifndef __STRICT_ANSI__
extern _ARMABI struct tm *localtime_r(const time_t * /*timer*/, struct tm * /*result*/);
#endif
   /*
    * converts the calendar time pointed to by timer into a broken-down time,
    ...
    */
extern _ARMABI size_t strftime(char * /*s*/, size_t /*maxsize*/,
