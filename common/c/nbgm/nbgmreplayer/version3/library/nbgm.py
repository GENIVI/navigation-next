    ...
    def run(self):
        ...
        while not self.__stopEvent.is_set():
            ...
            if self.__query_func and self.__respond_func:
                for k, func in self.__respond_func.items():
...
Please note that the main thread and the render thread could be seperated. 
    ...
    def create(self):
        return self.device.CreateNativeDevice(self.workPath.encode('utf8'), self.tilePath.encode('utf8'), self.width, self.height, self.dpi, self.useOpenGL)
