...
VERSION_FILE := $(PROJ_ROOT)/include/$(PLATFORM)/abversioninfo.h
...
SRC_DIRS += $(PROJ_ROOT)/src/datastore
SRC_DIRS += $(PROJ_ROOT)/src/ers
SRC_DIRS += $(PROJ_ROOT)/src/fileset
SRC_DIRS += $(PROJ_ROOT)/src/motd
SRC_DIRS += $(PROJ_ROOT)/src/msg
SRC_DIRS += $(PROJ_ROOT)/src/network
SRC_DIRS += $(PROJ_ROOT)/src/profile
SRC_DIRS += $(PROJ_ROOT)/src/qalog
SRC_DIRS += $(PROJ_ROOT)/src/sms
SRC_DIRS += $(PROJ_ROOT)/src/speech
SRC_DIRS += $(PROJ_ROOT)/src/subscription
SRC_DIRS += $(PROJ_ROOT)/src/sync
SRC_DIRS += $(PROJ_ROOT)/src/util
SRC_DIRS += $(PROJ_ROOT)/src/version
SRC_DIRS += $(PROJ_ROOT)/src/license
...
NIMNB_PATH    := $(NIMNB_INC) #supplied by user set enviromnment variable
NIMNB_DIR := $(subst \,/,$(strip $(NIMNB_PATH)))
NIMNB_PRIVATE_DIR := $(NIMNB_DIR)/private
NIMNB_PROTECTED_DIR := $(NIMNB_DIR)/protected
NIMNB_BREW_DIR := $(NIMNB_DIR)/$(PLATFORM)
...
INCLUDE_DIRS += $(NIMNB_DIR)
INCLUDE_DIRS += $(NIMNB_PRIVATE_DIR)
INCLUDE_DIRS += $(NIMNB_PROTECTED_DIR)
INCLUDE_DIRS += $(NIMNB_BREW_DIR)
